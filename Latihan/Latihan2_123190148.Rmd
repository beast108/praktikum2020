...
Agar dapat bekerja secara efisien dalam menggunakan bahasa pemrograman R, penting untuk mempelajari terlebih dahulu tipe data dari variabel-variabel yang kita miliki sehingga akan mempermudah dalam penentuan proses analisis data yang dapat dilakukan terhadap variabelvariabel tersebut.
...
Untuk mengetahui nama-nama dari lima variabel yang dapat dievaluasi menggunakan operator aksesor, sebelumnya, melalui fungsi str, telah kita ketahui bahwa variabel yang dimiliki datasetadalah: state, abb, region, population, dan total. Sebagai alternatif, terdapat pula fungsi name,yang dapat digunakan seperti contoh dibawah ini:
```
names(murders) 
